<template>
      ...
      <nav id="sidebar" class="sidebar">
        ...
        <div class="p-4">
          ...
          <ul class="list-unstyled components mb-5">
            <li class="float-left">
              <router-link to="">
                ...
                <span @click="approveBtn"
                  >อนุมัติผู้ใช้งาน
                  <!-- <span class="badge badge-pill badge-primary">{{$store.state.teacherApproveCount + $store.state.employeeApproveCount}}</span> -->
                </span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                <i class="fas fa-registered text-white"></i>
                <span class="mr-3"></span>
                <span @click="enrollBtn">สมัครเรียน</span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                ...
                <span class="mr-3"></span>
                <span @click="teacherDataBtn">ข้อมูลครูผู้สอน</span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                ...
                <span class="mr-3"></span>
                <span @click="employeeDataBtn">ข้อมูลพนักงาน</span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="/admin/approve">
                <i class="fas fa-user-graduate text-white"></i>
                <span class="mr-3"></span> ข้อมูลนักเรียน
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                ...
                <span class="mr-3"></span>
                <span @click="addCourseBtn">ข้อมูลวิชาเรียน</span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                ...
                <span class="mr-3"></span>
                <span @click="addProductBtn">ระบบ Stock สินค้า</span>
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                <i class="fas fa-arrow-circle-right text-white"></i>
                <span class="mr-3"></span> ระบบAttendance
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
            ...
            <li class="float-left">
              <router-link to="">
                <i class="fas fa-paste text-white"></i>
                <span class="mr-3"></span> รายงาน (Report)
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="">
                ...
                <span class="mr-3"></span>
                ระบบจัดการหน้าปฏิทิน
              </router-link>
            </li>
            <li class="float-left">
              <router-link to="/user/userProfile">
                <span class="fas fa-university mr-3"></span> ระบบบัญชี
              </router-link>
            </li>
            <li class="float-left">
              <a @click="signOut" style="cursor: pointer">
                <span class="fa fa-power-off mr-3"></span> ออกจากระบบ
              </a>
            </li>
          </ul>
          <!-- <div class="mb-5">
          ...
          <!-- <div class="footer">
            <p>
              Copyright &copy;
              <script type="a8994114985885703154f0b1-text/javascript">
  document.write(new Date().getFullYear());
      ...
      <!-- p-4 p-md-5 pt-5 -->
      <div id="content" class="px-4 my-content">
        <!-- <h2 class="mb-4">Sidebar #05</h2> -->

        <div v-if="$store.state.page === 'approvePage'">
          <approvePage></approvePage>
        </div>
        <div v-if="$store.state.page === 'enrollPage'">
          <EnrollPage></EnrollPage>
        </div>
        <div v-if="$store.state.page === 'addProductPage'">
          <AddProduct></AddProduct>
        </div>
        <div v-if="$store.state.page === 'addCoursePage'">
          <AddCourse></AddCourse>
        </div>
        <div v-if="$store.state.page === 'teacherDataPage'">
          <TeacherData></TeacherData>
        </div>
        <div v-if="$store.state.page === 'employeeDataPage'">
...
import EmployeeData from "@/components/admins/EmployeeData.vue";
...
export default {
  ...
  methods: {
    approveBtn() {
      console.log("click");
      this.$store.state.page = "approvePage";
    },
    enrollBtn() {
      this.$store.state.page = "enrollPage";
    },
    addProductBtn() {
      this.$store.state.page = "addProductPage";
    },
    addCourseBtn() {
      this.$store.state.page = "addCoursePage";
    },
    teacherDataBtn() {
      this.$store.state.page = "teacherDataPage";
    },
    employeeDataBtn() {
      this.$store.state.page = "employeeDataPage";
    },
