<template>
  <div class="container jumbotron">
    <h4 class="text-center text-success mb-3">ข้อมูลและประวัติพนักงาน</h4>
    <div class="row">
      <div class="col-lg-12">
        <div id="preview">
          <img
    ...
    <form v-on:submit.prevent v-if="detailOpen">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="namePrefix" class="text-success"><span class="text-danger">*</span>คำนำหน้า</label>
            <select
              class="form-control"
              id="namePrefix"
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="nickName" class="text-success"><span class="text-danger">*</span>ชื่อเล่น</label>
            <input
              type="text"
              class="form-control"
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="firstName" class="text-success"><span class="text-danger">*</span>ชื่อจริง</label>
            <input
              type="text"
              class="form-control"
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="lastName" class="text-success"><span class="text-danger">*</span>นามสกุล</label>
            <input
              type="text"
              class="form-control"
      ...
      <div class="row mt-3">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="addressNumber" class="text-success"><span class="text-danger">*</span>บ้านเลขที่ </label>
            <input
              type="text"
              class="form-control"
      ...
      <div class="row mt-2">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="email" class="text-success"><span class="text-danger">*</span>แขวง/ตำบล </label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="email" class="text-success"><span class="text-danger">*</span>เขต/อำเภอ </label>
            <ThailandAutoComplete
      ...
      <div class="row mt-2">
        <div class="col-lg-6">
          <div class="form-group" >
            <label for="email" class="text-success"><span class="text-danger">*</span>จังหวัด </label>
            <ThailandAutoComplete
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="email" class="text-success"><span class="text-danger">*</span>รหัสไปรษณีย์ </label>
            <ThailandAutoComplete
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="level" class="text-success"><span class="text-danger">*</span>ระดับการศึกษาสูงสุด</label>
            <select
              class="form-control"
              id="level"
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group">
            <label for="email" class="text-success"><span class="text-danger">*</span>ระดับชั้น / คณะ</label>
            <input
              type="email"
              class="form-control"
  ...
  -ตำแหน่งผู้จัดการ ที่ โรงเรียนสอนดนตรี Yamaha ปี 2560-2561         
  -ตำแหน่งผู้จัดการ ที่ โรงเรียนสอนดนตรีเมโลดิอุส ปี 2562-ปัจจุบัน"
  ...
  methods: {
    ...
    uploadImage() {
      if (this.imageName != null) {
        ...
        var storageRef = fb
          .storage()
          .ref("employeeImg/" + Math.random() + "_" + file.name);
